...
#     wallet_types = ['Savings', 'Investment', 'Emergencies', 'Main']
#     wallet_statuses = ['Active', 'Inactive']
#     wallet_list = []
...
#--------------wallet and user profile relationship test
    wallet = Wallet.query.filter_by(user_prof_id =51).all()[1]
    print(wallet)
